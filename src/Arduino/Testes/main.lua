...
local colecaoTestes = {}
	...
	colecaoTestes[5] = assert(codev, "403",failCode)
	colecaoTestes[6] = assert(codel, "403",failCode)
	username = luser
	a, codev = switchPower(0)
	a, codel = switchPower(1)
	...
	a, codev = switchPower(0)
	a, codel = switchPower(1)
	colecaoTestes[9] = assert(codel, "405",failParans)
	colecaoTestes[10] = assert(codev, "405",failParans)
	...
	a, codev = switchPower(0)
	a, codel = switchPower(1)
	colecaoTestes[13] = assert(codel, "402",failParans)
	colecaoTestes[14] = assert(codev, "402",failParans)
	getReqBody = mqreqbody
	a, codev = switchPower(0)
	a, codel = switchPower(1)
